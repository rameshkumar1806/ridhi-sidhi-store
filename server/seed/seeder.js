    ...
    await Banner.insertMany([
      {
        ...
        image: 'https://placehold.co/1200x500/FF6B35/white?text=Fresh+Groceries+Delivered+Daily',
        link: '/products',
        buttonText: 'Shop Now',
        type: 'hero',
        sortOrder: 1,
      ...
      },
      {
        ...
        image: 'https://placehold.co/1200x500/F59E0B/white?text=Pure+Ghee+And+Oils',
